...
public class UnitAIStateMachine : BaseAIStateMachine
{
    ...
    public UnitAIStateMachine(EnemyIdleState idle, EnemyPatrolState patrol, EnemyMovingToTargetState movingToTargetState, EnemyMoveToTargetPreparingState moveToTargetPreparingState, 
